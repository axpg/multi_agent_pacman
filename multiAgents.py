...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState: GameState, action):
        ...
        # the state we get after taking an action
        ...
        "*** YOUR CODE HERE ***"
        return score + (1/food_dist) - (1/ghost_dist)
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState: GameState):
        ...
        for action in actions:
            ...
            state_value = self.minimaxHelper(succesorState, 1, 0)
            if state_value > value:
                value = state_value
                optimal_action = action
        return optimal_action
    
    def minimaxHelper(self, gameState: GameState, agentIndex: int, depth: int):
        ...
        if agentIndex == 0:
            ...
            for action in actions:
                ...
                max_value = max(max_value, self.minimaxHelper(successorState, next_agent_index, next_depth))
            return max_value
        # must be a ghost/minimizer
            ...
            for action in actions:
                successorState = gameState.generateSuccessor(agentIndex, action)
                min_value = min(min_value, self.minimaxHelper(successorState, next_agent_index, next_depth))
            return min_value
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    def getAction(self, gameState: GameState):
        ...
        for action in actions:
            succesorState = gameState.generateSuccessor(0, action)
            state_value = self.AlphaBetaHelper(succesorState, 1, 0, alpha, beta)
            if state_value > value:
                value = state_value
                optimal_action = action
    ...
    def AlphaBetaHelper(self, gameState: GameState, agentIndex: int, depth: int, alpha: int, beta: int):
        if gameState.isWin() or gameState.isLose() or depth == self.depth:
            return self.evaluationFunction(gameState)    
        ...
        if agentIndex == 0:
            ...
            for action in actions:
                successorState = gameState.generateSuccessor(agentIndex, action)
                max_value = max(max_value, self.AlphaBetaHelper(successorState, next_agent_index, next_depth, alpha, beta))
                if max_value > beta:
                    return max_value
        ...
        # must be a ghost/minimizer
            ...
            for action in actions:
                successorState = gameState.generateSuccessor(agentIndex, action)
                min_value = min(min_value, self.AlphaBetaHelper(successorState, next_agent_index, next_depth, alpha, beta))
                if min_value < alpha:
                    return min_value
